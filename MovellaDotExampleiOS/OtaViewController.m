...
#import <MovellaDotSdk/DotOtaManager.h>
 ...
 */
@interface OtaViewController ()<DotOtaManagerDelegate>
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [DotOtaManager setOtaManagerDelegate:self];
}
...
- (void)checkUpdateTapped:(UIButton *)sender
{
    if (!self.isProcessing)
    {
        ...
        [[DotOtaManager defaultManager]checkOtaUpdates:self.device];
    }
    else
    {
        [self showProcessing];
...
- (void)checkUpdateAndDownloadTapped:(UIButton *)sender
{
    ...
    {
        self.isProcessing = YES;
        [[DotOtaManager defaultManager]checkOtaUpdatesAndDownload:self.device];
    }
    else
    {
        [self showProcessing];
...
- (void)startOtaTapped:(UIButton *)sender
{
    if (!self.isProcessing)
    {
        ...
        {
            self.isProcessing = YES;
            [[DotOtaManager defaultManager]startOta:self.device];
        }
        else
        {
